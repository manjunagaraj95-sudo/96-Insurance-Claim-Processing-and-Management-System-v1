...
const App = () => {
  ...
  const FiltersPanel = () => {
    const uniqueStatuses = [...new Set(claimsData.map(c => c.status))];
  ...
  const MilestoneTracker = ({ workflow }) => {
    ...
    const activeIndex = currentStageIndex === -1 ? workflow?.length -1 : currentStageIndex;
      ...
      <div className="claim-detail-screen">
        ...
        <div className="detail-header">
          ...
          <div className="action-buttons">
            {canPerformAction('canEditClaim') && (
              <button>Edit Claim</button>
            )}
            {canPerformAction('canApproveReject') && claim?.status === 'Pending' && (
              <>
            ...
            {canPerformAction('canExportReports') && (
        ...
        <div className="detail-sections">
          <div className="detail-main-col">
            <div className="card">
              ...
              <p><strong>Status:</strong> <span className={`claim-card-status-pill ${getStatusClass(claim?.status)}`}>{claim?.status}</span></p>
              ...
              <p><strong>Assigned Officer:</strong> {claim?.assignedOfficer}</p>
  ...
  return (
    <div className="app-container">
      ...
      <main className="main-content">
        ...
        {view.screen === 'CLAIM_DETAIL' && <ClaimDetailScreen claimId={view.params.claimId} />}
      </main>
